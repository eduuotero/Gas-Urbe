...
interface ServiceFormStepObservationViewContainerProps {
  value: string;
  onChange: (value: string) => void;
}

export default function ServiceFormStepObservationViewContainer({ value, onChange }: ServiceFormStepObservationViewContainerProps) {
  return (
