...
interface ServiceFormStepSignatureViewProps {
  onSave: (data: string) => void;
  onClear: () => void;
  hasFirma: boolean;
}

export default function ServiceFormStepSignatureView({ onSave, onClear, hasFirma }: ServiceFormStepSignatureViewProps) {
  return (
