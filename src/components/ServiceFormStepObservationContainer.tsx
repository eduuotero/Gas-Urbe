...
interface ServiceFormStepObservationContainerProps {
  value: string;
  onChange: (value: string) => void;
}

export default function ServiceFormStepObservationContainer({ value, onChange }: ServiceFormStepObservationContainerProps) {
  return (
