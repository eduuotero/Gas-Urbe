...
interface ServiceFormStepActionsViewProps {
  onBack: () => void;
  onNext: () => void;
  isFirstStep: boolean;
  isLastStep: boolean;
...
export default function ServiceFormStepActionsView({ onBack, onNext, isFirstStep, isLastStep, isSubmitting, canNext = true }: ServiceFormStepActionsViewProps) {
  return (
