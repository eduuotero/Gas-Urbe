...
interface ServiceFormStepStatusViewContainerProps {
  selected: string;
  onSelect: (value: string) => void;
}

export default function ServiceFormStepStatusViewContainer({ selected, onSelect }: ServiceFormStepStatusViewContainerProps) {
  return (
