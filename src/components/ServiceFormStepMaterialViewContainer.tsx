...
interface ServiceFormStepMaterialViewContainerProps {
  materials: any[];
...
export default function ServiceFormStepMaterialViewContainer({ materials, onAdd, onRemove, onUpdate, availableMaterials }: ServiceFormStepMaterialViewContainerProps) {
  return (
