...
interface ServiceFormStepHeaderViewContainerProps {
  title: string;
  description: string;
  icon?: React.ReactNode;
}

export default function ServiceFormStepHeaderViewContainer({ title, description, icon }: ServiceFormStepHeaderViewContainerProps) {
  return (
