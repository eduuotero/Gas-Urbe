...
interface ServiceFormStepStatusContainerProps {
  selected: string;
  onSelect: (value: string) => void;
}

export default function ServiceFormStepStatusContainer({ selected, onSelect }: ServiceFormStepStatusContainerProps) {
  return (
