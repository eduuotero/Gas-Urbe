...
interface ServiceFormPhotoStepProps {
  label: string;
  description: string;
  photos: string[];
  onUpload: () => void;
...
export default function ServiceFormPhotoStep({ label, description, photos, onUpload, onRemove, maxPhotos = 5 }: ServiceFormPhotoStepProps) {
  return (
