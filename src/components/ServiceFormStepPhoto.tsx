...
interface ServiceFormStepPhotoProps {
  label: string;
  description: string;
  photos: string[];
  onUpload: () => void;
...
export default function ServiceFormStepPhoto({ label, description, photos, onUpload, onRemove, maxPhotos = 5 }: ServiceFormStepPhotoProps) {
  return (
