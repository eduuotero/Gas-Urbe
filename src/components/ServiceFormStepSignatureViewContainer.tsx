...
interface ServiceFormStepSignatureViewContainerProps {
  onSave: (data: string) => void;
  onClear: () => void;
  hasFirma: boolean;
}

export default function ServiceFormStepSignatureViewContainer({ onSave, onClear, hasFirma }: ServiceFormStepSignatureViewContainerProps) {
  return (
