...
interface ServiceFormStepMaterialViewProps {
  materials: any[];
...
export default function ServiceFormStepMaterialView({ materials, onAdd, onRemove, onUpdate, availableMaterials }: ServiceFormStepMaterialViewProps) {
  return (
