...
interface ServiceFormStepPhotoContainerProps {
  label: string;
  description: string;
  photos: string[];
  onUpload: () => void;
...
export default function ServiceFormStepPhotoContainer({ label, description, photos, onUpload, onRemove, maxPhotos = 5 }: ServiceFormStepPhotoContainerProps) {
  return (
