...
interface ServiceFormStepTypeViewContainerProps {
  types: string[];
  selected: string;
  onSelect: (type: string) => void;
}

export default function ServiceFormStepTypeViewContainer({ types, selected, onSelect }: ServiceFormStepTypeViewContainerProps) {
  return (
