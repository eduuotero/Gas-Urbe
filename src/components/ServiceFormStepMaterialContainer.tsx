...
interface ServiceFormStepMaterialContainerProps {
  materials: any[];
...
export default function ServiceFormStepMaterialContainer({ materials, onAdd, onRemove, onUpdate, availableMaterials }: ServiceFormStepMaterialContainerProps) {
  return (
