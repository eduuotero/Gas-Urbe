...
interface ServiceFormStepTypeContainerProps {
  types: string[];
  selected: string;
  onSelect: (type: string) => void;
}

export default function ServiceFormStepTypeContainer({ types, selected, onSelect }: ServiceFormStepTypeContainerProps) {
  return (
