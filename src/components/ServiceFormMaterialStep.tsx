...
interface ServiceFormMaterialStepProps {
  materials: any[];
...
export default function ServiceFormMaterialStep({ materials, onAdd, onRemove, onUpdate, availableMaterials }: ServiceFormMaterialStepProps) {
  return (
