...
interface ServiceFormStepActionsProps {
  onBack: () => void;
  onNext: () => void;
  isFirstStep: boolean;
  isLastStep: boolean;
...
export default function ServiceFormStepActions({ onBack, onNext, isFirstStep, isLastStep, isSubmitting, canNext = true }: ServiceFormStepActionsProps) {
  return (
