...
interface ServiceFormStepPhotoViewContainerProps {
  label: string;
  description: string;
  photos: string[];
  onUpload: () => void;
...
export default function ServiceFormStepPhotoViewContainer({ label, description, photos, onUpload, onRemove, maxPhotos = 5 }: ServiceFormStepPhotoViewContainerProps) {
  return (
