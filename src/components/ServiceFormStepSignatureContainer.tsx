...
interface ServiceFormStepSignatureContainerProps {
  onSave: (data: string) => void;
  onClear: () => void;
  hasFirma: boolean;
}

export default function ServiceFormStepSignatureContainer({ onSave, onClear, hasFirma }: ServiceFormStepSignatureContainerProps) {
  return (
