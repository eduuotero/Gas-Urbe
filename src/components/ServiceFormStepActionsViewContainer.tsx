...
interface ServiceFormStepActionsViewContainerProps {
  onBack: () => void;
  onNext: () => void;
  isFirstStep: boolean;
  isLastStep: boolean;
...
export default function ServiceFormStepActionsViewContainer({ onBack, onNext, isFirstStep, isLastStep, isSubmitting, canNext = true }: ServiceFormStepActionsViewContainerProps) {
  return (
