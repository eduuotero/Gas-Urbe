...
interface ServiceFormStepHeaderContainerProps {
  title: string;
  description: string;
  icon?: React.ReactNode;
}

export default function ServiceFormStepHeaderContainer({ title, description, icon }: ServiceFormStepHeaderContainerProps) {
  return (
