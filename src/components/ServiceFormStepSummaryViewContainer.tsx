...
interface ServiceFormStepSummaryViewContainerProps {
  data: any;
}

export default function ServiceFormStepSummaryViewContainer({ data }: ServiceFormStepSummaryViewContainerProps) {
  return (
