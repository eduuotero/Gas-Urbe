...
interface ServiceFormStepActionsContainerProps {
  onBack: () => void;
  onNext: () => void;
  isFirstStep: boolean;
  isLastStep: boolean;
...
export default function ServiceFormStepActionsContainer({ onBack, onNext, isFirstStep, isLastStep, isSubmitting, canNext = true }: ServiceFormStepActionsContainerProps) {
  return (
